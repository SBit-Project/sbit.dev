                ...
                <div
                    ...
                    <div className="sm:col-span-12 lg:col-span-3">
                        ...
                        <div className="text-sm  dark:text-gray-200">
                            <Link
                                to="#"
                                className=" dark:text-gray-200 hover:text-gray-900 hover:underline transition duration-150 ease-in-out"
                            >
                                Terms
                            </Link>{" "}
                            ·{" "}
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <Link
                                    to="#"
                                    className=" dark:text-gray-200 hover:text-gray-900 transition duration-150 ease-in-out"
                                >
                                    Web Studio
                                </Link>
                            </li>
                ...
                <div
                    ...
                    <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li>
                            <Link
                                to="#"
                                className="flex justify-center items-center  dark:text-gray-200 hover:text-gray-900  hover:-100 rounded-full shadow transition duration-150 ease-in-out"
                                aria-label="Twitter"
                            >
                                <svg
                    ...
                    <div className="text-sm  dark:text-gray-200 mr-4">
                        Made by{" "}
                        <a
