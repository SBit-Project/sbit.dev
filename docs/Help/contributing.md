...
on [http://www.erisian.com.au/sbit-core-dev/](http://www.erisian.com.au/sbit-core-dev/)
and [http://gnusha.org/sbit-core-dev/](http://gnusha.org/sbit-core-dev/).
...
For GUI-related issues or pull requests, the https://github.com/sbit-core/gui repository should be used.
...
https://github.com/sbit-core/bitcoin-maintainer-tools#backport).
