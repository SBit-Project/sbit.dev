...
description: This guide describes how to build sbitd, sbit-qt, and command-line utilities on OpenBSD.
...
This guide describes how to build sbitd, sbit-qt, and command-line utilities on OpenBSD.
...
:::caution
From OpenBSD 6.2 onwards a C++11-supporting clang compiler is
...
in contrib dir](https://github.com/SBit-Project/sbit/contrib/install_db4.sh) like so:
