...
[src/.clang-format](https://github.com/SBit-Project/sbit/src/.clang-format). You can use the provided
[clang-format-diff script](https://github.com/SBit-Project/sbit/contrib/devtools/README.md#clang-format-diffpy)
...
Refer to [/test/functional/README.md#style-guidelines](https://github.com/SBit-Project/sbit/test/functional/README.md#style-guidelines).
...
Run with the `-testnet` option to run with "play sbit" on the test network, if you
...
To profile a running sbitd process for 60 seconds, you could use an
...
- Use `Span` as function argument when it can operate on any range-like container.
  ...
  - *Rationale*: Compared to `Foo(const vector<int>&)` this avoids the need for a (potentially expensive)
    ...
    However, be aware of the pitfalls documented in [span.h](https://github.com/SBit-Project/sbit/src/span.h).
...
- Avoid using locale dependent functions if possible. You can use the provided
  [`lint-locale-dependence.sh`](https://github.com/SBit-Project/sbit/test/lint/lint-locale-dependence.sh)
...
All `release-notes*` files are merged into a single release-notes file prior to the release.
...
- Try not to overload methods on argument type. E.g. don't make `getblock(true)` and `getblock("hash")`
  ...
  - *Rationale*: This is impossible to use with `sbit-cli`, and can be surprising to users.
...
- Add every non-string RPC argument `(method, idx, name)` to the table `vRPCConvertParams` in `rpc/client.cpp`.
  ...
  - *Rationale*: `sbit-cli` and the GUI debug console use this table to determine how to
...
[`src/interfaces/`](https://github.com/SBit-Project/sbit/src/interfaces/). The main interface classes defined
there are [`interfaces::Chain`](https://github.com/SBit-Project/sbit/src/interfaces/chain.h), used by wallet to
access the node's latest chain state,
[`interfaces::Node`](https://github.com/SBit-Project/sbit/src/interfaces/node.h), used by the GUI to control the
node, and [`interfaces::Wallet`](https://github.com/SBit-Project/sbit/src/interfaces/wallet.h), used by the GUI
to control an individual wallet. There are also more specialized interface
types like [`interfaces::Handler`](https://github.com/SBit-Project/sbit/src/interfaces/handler.h)
[`interfaces::ChainClient`](https://github.com/SBit-Project/sbit/src/interfaces/chain.h) passed to and from
...
- Interface method definitions should wrap existing functionality instead of
  ...
  functionality should be implemented in [`src/node/`](https://github.com/SBit-Project/sbit/src/node/) or
  [`src/wallet/`](https://github.com/SBit-Project/sbit/src/wallet/) and just exposed in
  [`src/interfaces/`](https://github.com/SBit-Project/sbit/src/interfaces/) instead of being implemented there,
...
- For consistency and friendliness to code generation tools, interface method
  ...
  [`src/interfaces/`](https://github.com/SBit-Project/sbit/src/interfaces/), though it did come up for discussion
