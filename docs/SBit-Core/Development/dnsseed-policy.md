---
title: DNS Seed operators
description: Expectations for DNS Seed operators
...
for the operation of the service or urgent health of the SBit
...
discontinue providing services and contact the active SBit
