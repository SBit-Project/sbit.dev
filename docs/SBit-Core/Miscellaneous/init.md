---
title: Init
description: Sample init scripts and service configuration for sbitd
keywords: [sbit, bitcoin, blockchain, ethereum]
sidebar_position: 3
---

:::danger
This document and init scripts need review and change
:::
...
Using this script, you can adjust the path and flags to the d program by
setting the D and FLAGS environment variables in the file
