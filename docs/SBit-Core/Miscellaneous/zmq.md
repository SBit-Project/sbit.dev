---
title: ZMQ
description: Block and Transaction Broadcasting with ZeroMQ
keywords: [sbit, sbit, blockchain, ethereum]
sidebar_position: 9
---
...
The SBit Core daemon can be configured to act as a trusted "border
...
during the *configure* step of building sbitd:
...
For instance:
    ...
    $ sbitd -zmqpubhashtx=tcp://127.0.0.1:22501 \
...
These options can also be provided in sbit.conf.
...
From the perspective of sbitd, the ZeroMQ socket is write-only; PUB
