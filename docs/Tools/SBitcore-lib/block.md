---
title: SBIT Block
description: A Block instance represents the information of a block in the SBIT network
...
## Transactions
The set of transactions in a block is an array of instances of [Transaction](transaction) and can be explored by iterating on the block's `transactions` member.
