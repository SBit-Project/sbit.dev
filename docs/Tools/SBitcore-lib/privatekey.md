...
:::note
The WIF (Wallet Import Format) includes information about the network and if the associated public key is compressed or uncompressed (thus the same SBIT address will be generated by using this format).
:::
