...
```
git clone https://github.com/SBit-Project/sbit-ethjs-abi
npm install
```
...
`ethjs` uses webpack across all its browser focused repos. Webpack is used to package down project files into distribution builds for the browser. You can see the builds it produces by going to the dist folder.
